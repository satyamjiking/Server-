# main.py — Render-ready Selenium messenger sender (Full Debug + Updated detect_bins)
import os
import time
import threading
...
def detect_bins():
    chrome_bins = [
        ...
        "/snap/bin/chromium",  # कभी snap से install होता है
    ]
    driver_bins = [
    ...
    print("[DEBUG] chrome_bin:", chrome)
    print("[DEBUG] chromedriver_bin:", driver)
